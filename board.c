...
void performMove(struct Square* from, struct Square* to, unsigned char toFile, unsigned char toRank) {
	...
	// a jelenlegi adatmodellünkben egy mezőből nem tudhatjuk annak koordinátáit!...
		// ezért a lépéshez szükség van a cél koordinátáira is külön, a cél mező önmagában nem elég
